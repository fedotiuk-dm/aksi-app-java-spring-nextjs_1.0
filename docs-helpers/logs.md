...
backend-dev  | 21:11:46.163 ERROR [restartedMain] liquibase.changelog                      : ChangeSet db/changelog/item/008-insert-category-materials.yaml::008-insert-textile-materials::system encountered an exception.
backend-dev  | -
backend-dev  | liquibase.exception.DatabaseException: ERROR: relation "public.service_category_materials" does not exist
backend-dev  |   Position: 13 [Failed SQL: (0) INSERT INTO public.service_category_materials (service_category_id, materials) VALUES ((SELECT id FROM service_categories WHERE code = 'CLOTHING'), 'COTTON')]
...
backend-dev  | Caused by: org.postgresql.util.PSQLException: ERROR: relation "public.service_category_materials" does not exist
backend-dev  |   Position: 13
...
backend-dev  | Caused by: liquibase.exception.CommandExecutionException: liquibase.exception.LiquibaseException: liquibase.exception.MigrationFailedException: Migration failed for changeset db/changelog/item/008-insert-category-materials.yaml::008-insert-textile-materials::system:
backend-dev  |      Reason: liquibase.exception.DatabaseException: ERROR: relation "public.service_category_materials" does not exist
backend-dev  |   Position: 13 [Failed SQL: (0) INSERT INTO public.service_category_materials (service_category_id, materials) VALUES ((SELECT id FROM service_categories WHERE code = 'CLOTHING'), 'COTTON')]
...
backend-dev  | Caused by: liquibase.exception.LiquibaseException: liquibase.exception.MigrationFailedException: Migration failed for changeset db/changelog/item/008-insert-category-materials.yaml::008-insert-textile-materials::system:
backend-dev  |      Reason: liquibase.exception.DatabaseException: ERROR: relation "public.service_category_materials" does not exist
backend-dev  |   Position: 13 [Failed SQL: (0) INSERT INTO public.service_category_materials (service_category_id, materials) VALUES ((SELECT id FROM service_categories WHERE code = 'CLOTHING'), 'COTTON')]
...
backend-dev  | Caused by: liquibase.exception.MigrationFailedException: Migration failed for changeset db/changelog/item/008-insert-category-materials.yaml::008-insert-textile-materials::system:
backend-dev  |      Reason: liquibase.exception.DatabaseException: ERROR: relation "public.service_category_materials" does not exist
backend-dev  |   Position: 13 [Failed SQL: (0) INSERT INTO public.service_category_materials (service_category_id, materials) VALUES ((SELECT id FROM service_categories WHERE code = 'CLOTHING'), 'COTTON')]
...
backend-dev  | Caused by: liquibase.exception.DatabaseException: ERROR: relation "public.service_category_materials" does not exist
backend-dev  |   Position: 13 [Failed SQL: (0) INSERT INTO public.service_category_materials (service_category_id, materials) VALUES ((SELECT id FROM service_categories WHERE code = 'CLOTHING'), 'COTTON')]
backend-dev  | 	at liquibase.executor.jvm.JdbcExecutor$ExecuteStatementCallback.doInStatement(JdbcExecutor.java:497) ~[liquibase-core-4.29.2.jar:na]
backend-dev  | 	at liquibase.executor.jvm.JdbcExecutor.execute(JdbcExecutor.java:83) ~[liquibase-core-4.29.2.jar:na]
backend-dev  | 	at liquibase.executor.jvm.JdbcExecutor.execute(JdbcExecutor.java:185) ~[liquibase-core-4.29.2.jar:na]
