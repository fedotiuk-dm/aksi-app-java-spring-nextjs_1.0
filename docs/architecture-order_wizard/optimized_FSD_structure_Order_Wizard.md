...
- [ ] Створити папку `shared/schemas`
- [ ] Створити файл `shared/schemas/common.schema.ts`
...
- [ ] Створити файл `shared/schemas/index.ts` для експорту схем

#### 0.2. Інтеграція Zod з React Hook Form
- [ ] Створити файл `shared/hooks/use-zod-form.ts`
...
- [ ] Створити файл `shared/utils/zod.utils.ts`
...
- [ ] Створити папку `wizard`
- [ ] Створити підпапки `store`, `hooks`, `types`, `schemas`, `utils`
- [ ] Створити файл `index.ts` для експорту

#### 1.2. Реалізація навігаційного стору
- [ ] Створити папку `store/navigation`
- [ ] Створити файл `navigation.types.ts` з типами для навігації
  - Визначити тип для всіх кроків візарда
  - Визначити тип для історії навігації
  - Визначити тип для стану навігації
- [ ] Створити файл `navigation.initial.ts` з початковим станом
  - Визначити початковий крок
  - Визначити порядок кроків
  - Визначити початкову історію навігації
- [ ] Створити файл `navigation.store.ts` зі стором для навігації
...
- [ ] Створити файл `index.ts` для експорту стору

#### 1.3. Реалізація стору валідації
- [ ] Створити папку `store/validation`
- [ ] Створити файл `validation.types.ts` з типами для валідації
  - Визначити тип для стану валідації кожного кроку
  - Визначити тип для помилок валідації
- [ ] Створити файл `validation.initial.ts` з початковим станом
  - Визначити початковий стан валідації для всіх кроків
- [ ] Створити файл `validation.store.ts` зі стором для валідації
...
- [ ] Створити файл `store/index.ts` для експорту всіх сторів
  - Експортувати навігаційний стор
  - Експортувати стор валідації

#### 1.5. Реалізація Zod схем для валідації
- [ ] Створити файл `schemas/navigation.schema.ts`
...
- [ ] Створити файл `schemas/validation.schema.ts`
...
- [ ] Створити файл `hooks/use-wizard-navigation.ts`
...
- [ ] Створити файл `utils/wizard.utils.ts`
