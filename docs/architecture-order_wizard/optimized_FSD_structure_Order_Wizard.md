...
- [x] Створити підпапки `store`, `hooks`, `schemas`, `ui`
- [x] Створити файл `index.ts` для експорту

#### 2.2. Реалізація стору для клієнтів
- [x] Створити файл `store/client.types.ts` з типами для клієнтів
  - Визначити тип для клієнта
  - Визначити тип для пошукових параметрів
  - Визначити тип для стану стору
- [x] Створити файл `store/client.initial.ts` з початковим станом
  - Визначити початковий стан для клієнтів
  - Визначити початковий стан для пошуку
- [x] Створити файл `store/client.store.ts` зі стором для клієнтів
...
- [x] Створити файл `store/index.ts` для експорту стору
