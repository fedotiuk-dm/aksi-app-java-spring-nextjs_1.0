...
### 1. Керування станом через XState

XState ідеально підходить для моделювання складного процесу Wizard з чіткими станами і переходами:
...
- **XState контекст** для глобального стану замовлення
...
## Схема машини станів XState

XState допоможе моделювати процес OrderWizard з чіткими переходами:
...
### XState: Визначення машини станів
...
5. **Спростити дебаг** з інструментами візуалізації XState

Рекомендуємо почати з:
1. Визначення Zod схем для валідації даних
2. Проектування машини станів XState
...
├── OrderWizardStateContext.tsx      # Контекст стану візарду з XState
