 ...
 * Забезпечує консистентне відображення даних в різних частинах проекту
 *
 * FSD принципи:
 * - Універсальний molecule для відображення структурованої інформації
 * - Не містить domain-специфічної логіки
 * - Забезпечує консистентний UX для всіх інформаційних карток
 *
