...
/**
 * Універсальний компонент для введення адреси
 * Підтримує як структурований, так і простий режими
 *
 * FSD принципи:
 * - Універсальний molecule для роботи з адресами
 * - Не містить domain-специфічної логіки
 * - Забезпечує гнучкі режими відображення
 *
 * Особливості:
 * - Інкапсулює логіку роботи з адресою
 * - Надає гнучкі режими відображення (простий/структурований/обидва)
