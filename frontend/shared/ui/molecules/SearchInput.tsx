 ...
 * Забезпечує консистентний стиль та поведінку для всіх пошукових полів в проекті
 *
 * FSD принципи:
 * - Універсальний molecule для пошукових полів
 * - Не містить domain-специфічної логіки
 * - Забезпечує консистентний UX для всіх пошукових інтерфейсів
 *
 * Особливості:
