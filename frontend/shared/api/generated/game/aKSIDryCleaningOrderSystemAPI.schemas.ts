...
/**
 * Operation type for applying the modifier
 */
export type PriceModifierOperation = typeof PriceModifierOperation[keyof typeof PriceModifierOperation];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PriceModifierOperation = {
  ADD: 'ADD',
  SUBTRACT: 'SUBTRACT',
  MULTIPLY: 'MULTIPLY',
  DIVIDE: 'DIVIDE',
...
export type PriceModifierCategoryRestrictionsItem = typeof PriceModifierCategoryRestrictionsItem[keyof typeof PriceModifierCategoryRestrictionsItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PriceModifierCategoryRestrictionsItem = {
  CLOTHING: 'CLOTHING',
  LAUNDRY: 'LAUNDRY',
  IRONING: 'IRONING',
  LEATHER: 'LEATHER',
...
export interface PriceModifier {
  ...
  /** Operation type for applying the modifier */
  operation?: PriceModifierOperation;
  ...
  categoryRestrictions?: PriceModifierCategoryRestrictionsItem[];
  /** Is modifier active */
  active: boolean;
...
export type DiscountExcludedCategoriesItem = typeof DiscountExcludedCategoriesItem[keyof typeof DiscountExcludedCategoriesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DiscountExcludedCategoriesItem = {
  CLOTHING: 'CLOTHING',
  LAUNDRY: 'LAUNDRY',
  IRONING: 'IRONING',
  LEATHER: 'LEATHER',
...
export interface Discount {
  ...
  excludedCategories?: DiscountExcludedCategoriesItem[];
  /** Is discount active */
  active: boolean;
  /** Sort order for display */
  sortOrder?: number;
...
export interface JsonNullableCalculationFormula {
  present?: boolean;
}
...
export interface PriceConfiguration {
  ...
  calculationFormula?: JsonNullableCalculationFormula;
  active: boolean;
  /** @minimum 0 */
  sortOrder: number;
  createdAt?: string;
...
export type GameModifierInfoType = typeof GameModifierInfoType[keyof typeof GameModifierInfoType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GameModifierInfoType = {
  TIMING: 'TIMING',
  SUPPORT: 'SUPPORT',
  MODE: 'MODE',
  QUALITY: 'QUALITY',
...
export type GameModifierInfoOperation = typeof GameModifierInfoOperation[keyof typeof GameModifierInfoOperation];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GameModifierInfoOperation = {
  ADD: 'ADD',
  SUBTRACT: 'SUBTRACT',
  MULTIPLY: 'MULTIPLY',
  DIVIDE: 'DIVIDE',
...
export interface GameModifierInfo {
  /** Modifier ID */
  id: string;
  /** Unique modifier code within game */
  code: string;
  /** Modifier display name */
  name: string;
  /** Detailed description */
  description?: string;
  type: GameModifierInfoType;
  operation: GameModifierInfoOperation;
  /** Modifier value: - For ADD/SUBTRACT: amount in cents (e.g., 5000 = $50.00) - For MULTIPLY: multiplier * 100 (e.g., 150 = 1.5x, 200 = 2.0x) - For DIVIDE: divisor * 100 (e.g., 200 = divide by 2.0)  */
  value: number;
  /** Game this modifier belongs to */
  gameCode: string;
  /** Service types this modifier applies to */
  serviceTypeCodes?: string[];
  /** Is modifier active and available */
  active: boolean;
  /** Display order */
  sortOrder?: number;
  ...
  color?: string;
  /**
   * Priority for applying multiple modifiers (higher = applied later)
   * @minimum 0
   * @maximum 100
   */
  priority?: number;
  /**
   * Maximum number of times this modifier can be used (null = unlimited)
   * @minimum 1
   */
  maxUses?: number;
  /** Date when modifier becomes effective */
  effectiveDate?: string;
  /** Date when modifier expires */
  expirationDate?: string;
  /** JSON conditions for applying modifier */
  conditions?: string;
  /** Creation timestamp */
  createdAt?: string;
  /** Last update timestamp */
...
export type UpdateGameModifierRequestType = typeof UpdateGameModifierRequestType[keyof typeof UpdateGameModifierRequestType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateGameModifierRequestType = {
  TIMING: 'TIMING',
  SUPPORT: 'SUPPORT',
  MODE: 'MODE',
  QUALITY: 'QUALITY',
...
export type UpdateGameModifierRequestOperation = typeof UpdateGameModifierRequestOperation[keyof typeof UpdateGameModifierRequestOperation];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateGameModifierRequestOperation = {
  ADD: 'ADD',
  SUBTRACT: 'SUBTRACT',
  MULTIPLY: 'MULTIPLY',
  DIVIDE: 'DIVIDE',
...
export interface UpdateGameModifierRequest {
  /** Modifier display name */
  name?: string;
  /** Detailed description */
  description?: string;
  type?: UpdateGameModifierRequestType;
  operation?: UpdateGameModifierRequestOperation;
  /** Modifier value */
  value?: number;
...
export type CreateGameModifierRequestType = typeof CreateGameModifierRequestType[keyof typeof CreateGameModifierRequestType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateGameModifierRequestType = {
  TIMING: 'TIMING',
  SUPPORT: 'SUPPORT',
  MODE: 'MODE',
  QUALITY: 'QUALITY',
...
export type CreateGameModifierRequestOperation = typeof CreateGameModifierRequestOperation[keyof typeof CreateGameModifierRequestOperation];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateGameModifierRequestOperation = {
  ADD: 'ADD',
  SUBTRACT: 'SUBTRACT',
  MULTIPLY: 'MULTIPLY',
  DIVIDE: 'DIVIDE',
...
export interface CreateGameModifierRequest {
  /** Unique modifier code */
  code: string;
  /** Modifier display name */
  name: string;
  /** Detailed description */
  description?: string;
  type: CreateGameModifierRequestType;
  operation: CreateGameModifierRequestOperation;
  /** Modifier value */
  value: number;
  /** Game code */
  gameCode: string;
...
export interface CalculationBreakdown {
  /** Base formula calculation in cents */
...
export interface CalculationMetadata {
  ...
  appliedModifiersCount?: number;
  /** Difference between target and start level */
  levelDifference?: number;
}

export type ModifierAdjustmentType = typeof ModifierAdjustmentType[keyof typeof ModifierAdjustmentType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ModifierAdjustmentType = {
  PERCENTAGE: 'PERCENTAGE',
  FIXED: 'FIXED',
  MULTIPLIER: 'MULTIPLIER',
} as const;
...
export interface ModifierAdjustment {
  ...
  adjustment?: number;
  type?: ModifierAdjustmentType;
}

export type UniversalCalculationResponseStatus = typeof UniversalCalculationResponseStatus[keyof typeof UniversalCalculationResponseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UniversalCalculationResponseStatus = {
  SUCCESS: 'SUCCESS',
  FAILED: 'FAILED',
  FALLBACK: 'FALLBACK',
} as const;

export type UniversalCalculationResponseFormulaType = typeof UniversalCalculationResponseFormulaType[keyof typeof UniversalCalculationResponseFormulaType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UniversalCalculationResponseFormulaType = {
  LINEAR: 'LINEAR',
  RANGE: 'RANGE',
  FORMULA: 'FORMULA',
  TIME_BASED: 'TIME_BASED',
...
/**
 * Response schema for universal calculation endpoint
 */
export interface UniversalCalculationResponse {
  /** Final price in cents */
  finalPrice: number;
  currency?: string;
  status: UniversalCalculationResponseStatus;
  breakdown: CalculationBreakdown;
  formulaType: UniversalCalculationResponseFormulaType;
  metadata?: CalculationMetadata;
}

/**
 * Any additional calculation parameters (values as integers)
 */
export type UniversalCalculationContextAdditionalParameters = {[key: string]: number};

/**
 * Complete calculation context
 */
export interface UniversalCalculationContext {
  gameCode?: string;
  ...
  modifiers?: string[];
  /** Any additional calculation parameters (values as integers) */
  additionalParameters?: UniversalCalculationContextAdditionalParameters;
}

/**
 * Request schema for universal calculation endpoint
 */
export interface UniversalCalculationRequest {
  formula?: JsonNullableCalculationFormula;
  context: UniversalCalculationContext;
}
...
export type GameModifierType = typeof GameModifierType[keyof typeof GameModifierType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GameModifierType = {
  TIMING: 'TIMING',
  SUPPORT: 'SUPPORT',
  MODE: 'MODE',
  QUALITY: 'QUALITY',
...
export type GameModifierOperation = typeof GameModifierOperation[keyof typeof GameModifierOperation];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GameModifierOperation = {
  ADD: 'ADD',
  SUBTRACT: 'SUBTRACT',
  MULTIPLY: 'MULTIPLY',
  DIVIDE: 'DIVIDE',
...
export interface GameModifier {
  ...
  /** Detailed description */
  description?: string;
  type: GameModifierType;
  operation: GameModifierOperation;
  /** Modifier value: - For ADD/SUBTRACT: amount in cents (e.g., 5000 = $50.00) - For MULTIPLY: multiplier * 100 (e.g., 150 = 1.5x, 200 = 2.0x) - For DIVIDE: divisor * 100 (e.g., 200 = divide by 2.0)  */
  value: number;
  /** Game this modifier belongs to */
  gameCode: string;
...
export interface GameModifiersResponse {
...
/**
 * Key type (RSA for asymmetric encryption, EC for elliptic curve)
 */
...
/**
 * Public key use (signature verification or encryption)
 */
...
/**
 * Algorithm used for signing/encryption
 */
...
export interface Jwk {
  ...
  alg: JwkAlg;
  /**
   * X.509 certificate chain (base64 encoded). Allows verification of key ownership and trust chain validation
   * @minItems 1
   * @maxItems 5
   */
  x5c?: string[];
  /**
   * X.509 certificate thumbprint (SHA-1 hash, base64url encoded)
   * @pattern ^[a-zA-Z0-9_-]{40,88}$
   */
  x5t?: string;
  /**
   * X.509 certificate thumbprint with SHA-256 (more secure than x5t)
   * @pattern ^[a-zA-Z0-9_-]{43,88}$
   */
  'x5t#S256'?: string;
  /** Issued at time (Unix timestamp) - when key was created */
  iat?: number;
  /** Expiration time (Unix timestamp) - when key expires */
  exp?: number;
...
export type GamesListGamesParams = {
/**
 * Page number (0-based)
 * @minimum 0
 */
...
export type GamesListServiceTypesParams = {
/**
 * Page number (0-based)
 * @minimum 0
 */
...
export type GamesListPriceConfigurationsParams = {
/**
 * Page number (0-based)
 * @minimum 0
 */
...
export type ListGameModifiersParams = {
/**
 * Page number (0-based)
 * @minimum 0
 */
 ...
 * Sort direction
 */
sortOrder?: ListGameModifiersSortOrder;
/**
 * Free text search
 * @pattern ^[\w\s\p{L}\p{M}\p{N}\p{P}\p{S}]{0,255}$
 */
 ...
 */
type?: ListGameModifiersType;
/**
 * Filter by operation type
 */
operation?: ListGameModifiersOperation;
/**
 * Filter by active status
 */
active?: boolean;
...
export type ListGameModifiersSortOrder = typeof ListGameModifiersSortOrder[keyof typeof ListGameModifiersSortOrder];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListGameModifiersSortOrder = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;

export type ListGameModifiersType = typeof ListGameModifiersType[keyof typeof ListGameModifiersType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListGameModifiersType = {
  TIMING: 'TIMING',
  SUPPORT: 'SUPPORT',
  MODE: 'MODE',
  QUALITY: 'QUALITY',
...
export type ListGameModifiersOperation = typeof ListGameModifiersOperation[keyof typeof ListGameModifiersOperation];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListGameModifiersOperation = {
  ADD: 'ADD',
  SUBTRACT: 'SUBTRACT',
  MULTIPLY: 'MULTIPLY',
  DIVIDE: 'DIVIDE',
...
export type GamesListDifficultyLevelsParams = {
/**
 * Page number (0-based)
 * @minimum 0
 */
...
export type GamesListBoostersParams = {
/**
 * Page number (0-based)
 * @minimum 0
 */
...
export type GamesSetServiceTypeActiveParams = {
/**
 * Active status
 */
active: boolean;
