...
export type DeleteStainType200 = { [key: string]: unknown };

export type GetModifierById200 = { [key: string]: unknown };

export type UpdateModifier200 = { [key: string]: unknown };

export type DeactivateModifier200 = { [key: string]: unknown };

export type GetItemById200 = { [key: string]: unknown };

export type UpdatePriceListItem200 = { [key: string]: unknown };

export type UpdateCategory200 = { [key: string]: unknown };

export type DeleteOrderItem204 = { [key: string]: unknown };

export type UpdateOrderCompletion200 = { [key: string]: unknown };

export type UpdatePhotoAnnotationsParams = {
/**
 * JSON з анотаціями
 */
annotations: string;
...
export type GetDefectTypeById200 = { [key: string]: unknown };

export type DeleteClient204 = { [key: string]: unknown };
...
export type GetStainTypesRiskLevel = typeof GetStainTypesRiskLevel[keyof typeof GetStainTypesRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetStainTypesRiskLevel = {
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  HIGH: 'HIGH',
} as const;

export type CreateStainType200 = { [key: string]: unknown };

export type GetAllModifiers200 = { [key: string]: unknown };

export type CreateModifier200 = { [key: string]: unknown };

export type CreatePriceListItem200 = { [key: string]: unknown };

export type CreateCategory200 = { [key: string]: unknown };

export type GetModifiersByCodes200 = { [key: string]: unknown };

export type GetRequirements200 = { [key: string]: unknown };

export type UpdateRequirements200 = { [key: string]: unknown };

export type GetOrderPayment200 = { [key: string]: unknown };

export type ApplyPayment200 = { [key: string]: unknown };

export type CalculatePayment200 = { [key: string]: unknown };

export type EmailReceipt200 = { [key: string]: unknown };

export type ApplyDiscount1200 = { [key: string]: unknown };

export type CalculateCompletionDate200 = { [key: string]: unknown };
...
export type GetDefectTypesParams = {
activeOnly?: boolean;
riskLevel?: GetDefectTypesRiskLevel;
};

export type GetDefectTypesRiskLevel = typeof GetDefectTypesRiskLevel[keyof typeof GetDefectTypesRiskLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetDefectTypesRiskLevel = {
  LOW: 'LOW',
  MEDIUM: 'MEDIUM',
  HIGH: 'HIGH',
} as const;
...
export type IsUnitSupportedForItemParams = {
categoryId: string;
itemName: string;
unitOfMeasure: string;
};

export type GetStainTypeByCode200 = { [key: string]: unknown };

export type GetAllActiveCategories200 = { [key: string]: unknown };

export type GetCategoryById200 = { [key: string]: unknown };
...
export type GetModifierByCode200 = { [key: string]: unknown };

export type GetModifiersByCategoryParams = {
category: GetModifiersByCategoryCategory;
};

export type GetModifiersByCategoryCategory = typeof GetModifiersByCategoryCategory[keyof typeof GetModifiersByCategoryCategory];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetModifiersByCategoryCategory = {
  GENERAL: 'GENERAL',
  TEXTILE: 'TEXTILE',
  LEATHER: 'LEATHER',
} as const;

export type GetModifiersByCategory200 = { [key: string]: unknown };

export type GetAllCategories200 = { [key: string]: unknown };

export type GetCategoryById1200 = { [key: string]: unknown };

export type GetCategoryByCode1200 = { [key: string]: unknown };

export type GetAvailableUnitsOfMeasure200 = { [key: string]: unknown };

export type GetItemsByCategory200 = { [key: string]: unknown };

export type GetItemNamesByCategory200 = { [key: string]: unknown };

export type GetItemsByCategoryCode200 = { [key: string]: unknown };

export type GetRiskWarningsParams = {
stains?: string[];
defects?: string[];
categoryCode?: string;
materialType?: string;
...
export type GetModifiersByCategory1200 = { [key: string]: unknown };

export type GetModifiersForServiceCategory1200 = { [key: string]: unknown };

export type GetBasePriceParams = {
categoryCode: string;
itemName: string;
color?: string;
};

export type GetBasePrice200 = { [key: string]: unknown };

export type GetAvailableModifiersForCategoryParams = {
categoryCode: string;
};

export type GetAvailableModifiersForCategory200 = { [key: string]: unknown };
...
export type GetOrderReceipt200 = { [key: string]: unknown };

export type GetOrderDiscount200 = { [key: string]: unknown };

export type RemoveDiscount200 = { [key: string]: unknown };

export type DeletePhoto204 = { [key: string]: unknown };

export type GetRecommendedModifiersForStainsParams = {
stains: string[];
categoryCode?: string;
materialType?: string;
};

export type GetRiskWarningsForItemParams = {
stains?: string[];
defects?: string[];
materialType?: string;
categoryCode?: string;
...
export type GetRecommendedModifiersForDefectsParams = {
defects: string[];
categoryCode?: string;
materialType?: string;
};
