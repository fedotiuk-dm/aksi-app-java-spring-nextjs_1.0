...
export type Substep5AddPhotoBody = {
  file: Blob;
};
...
export type Substep1SelectPriceListItemParams = {
itemId: string;
};

export type Substep1SelectServiceCategoryParams = {
categoryId: string;
};

export type Substep1EnterQuantityParams = {
quantity: number;
};
...
export type Stage3GetSessionState200 = typeof Stage3GetSessionState200[keyof typeof Stage3GetSessionState200];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const Stage3GetSessionState200 = {
  STAGE3_INIT: 'STAGE3_INIT',
  EXECUTION_PARAMS_INIT: 'EXECUTION_PARAMS_INIT',
  DATE_SELECTION: 'DATE_SELECTION',
  URGENCY_SELECTION: 'URGENCY_SELECTION',
...
export type Stage3GetNextSubstep200 = typeof Stage3GetNextSubstep200[keyof typeof Stage3GetNextSubstep200];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const Stage3GetNextSubstep200 = {
  STAGE3_INIT: 'STAGE3_INIT',
  EXECUTION_PARAMS_INIT: 'EXECUTION_PARAMS_INIT',
  DATE_SELECTION: 'DATE_SELECTION',
  URGENCY_SELECTION: 'URGENCY_SELECTION',
...
export type OrderWizardGetSessionInfo200 = {[key: string]: unknown};

export type OrderWizardGetAvailableTransitions200 = {[key: string]: unknown};
