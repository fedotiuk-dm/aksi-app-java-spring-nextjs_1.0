...
export const stage3UpdatePaymentConfigBody = zod.object({
  ...
  "prepaymentAmount": zod.number().min(stage3UpdatePaymentConfigBodyPaymentRequestPrepaymentAmountMin).optional()
}).strict().optional(),
...
export const stage3UpdateDiscountConfigBody = zod.object({
  ...
  "discountPercentage": zod.number().min(stage3UpdateDiscountConfigBodyDiscountRequestDiscountPercentageMin).max(stage3UpdateDiscountConfigBodyDiscountRequestDiscountPercentageMax).optional(),
  "discountDescription": zod.string().min(stage3UpdateDiscountConfigBodyDiscountRequestDiscountDescriptionMin).max(stage3UpdateDiscountConfigBodyDiscountRequestDiscountDescriptionMax).optional()
}).strict().optional(),
...
export const stage3UpdateAdditionalInfoBody = zod.object({
  ...
  "orderId": zod.string().uuid(),
  "additionalRequirements": zod.string().min(stage3UpdateAdditionalInfoBodyAdditionalInfoRequestAdditionalRequirementsMin).max(stage3UpdateAdditionalInfoBodyAdditionalInfoRequestAdditionalRequirementsMax).optional(),
  "customerNotes": zod.string().min(stage3UpdateAdditionalInfoBodyAdditionalInfoRequestCustomerNotesMin).max(stage3UpdateAdditionalInfoBodyAdditionalInfoRequestCustomerNotesMax).optional()
}).strict().optional(),
...
export const stage2UpdateItemInOrderBody = zod.object({
  ...
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2UpdateItemInOrderBodyNameMin).max(stage2UpdateItemInOrderBodyNameMax),
  "description": zod.string().min(stage2UpdateItemInOrderBodyDescriptionMin).max(stage2UpdateItemInOrderBodyDescriptionMax).optional(),
  ...
  "specialInstructions": zod.string().min(stage2UpdateItemInOrderBodySpecialInstructionsMin).max(stage2UpdateItemInOrderBodySpecialInstructionsMax).optional(),
  ...
  "defectsNotes": zod.string().min(stage2UpdateItemInOrderBodyDefectsNotesMin).max(stage2UpdateItemInOrderBodyDefectsNotesMax).optional()
}).strict()
...
export const stage2UpdateItemInOrder200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2UpdateItemInOrder200ResponseAddedItemsItemNameMin).max(stage2UpdateItemInOrder200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2UpdateItemInOrder200ResponseAddedItemsItemDescriptionMin).max(stage2UpdateItemInOrder200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2UpdateItemInOrder200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2UpdateItemInOrder200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2UpdateItemInOrder200ResponseAddedItemsItemDefectsNotesMin).max(stage2UpdateItemInOrder200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
...
export const stage2DeleteItemFromOrder200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2DeleteItemFromOrder200ResponseAddedItemsItemNameMin).max(stage2DeleteItemFromOrder200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2DeleteItemFromOrder200ResponseAddedItemsItemDescriptionMin).max(stage2DeleteItemFromOrder200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2DeleteItemFromOrder200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2DeleteItemFromOrder200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2DeleteItemFromOrder200ResponseAddedItemsItemDefectsNotesMin).max(stage2DeleteItemFromOrder200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage1GetBasicOrderData200Response = zod.object({
  ...
  "phone": zod.string().regex(stage1GetBasicOrderData200ResponseSelectedBranchPhoneRegExp).optional(),
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage1GetBasicOrderData200ResponseAvailableBranchesItemPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage1GetBasicOrderData200ResponseAllBranchesItemPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
  ...
  "branchesCount": zod.number().optional()
}).strict()
...
export const stage1UpdateBasicOrderBody = zod.object({
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage1UpdateBasicOrderBodySelectedBranchPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage1UpdateBasicOrderBodyAvailableBranchesItemPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage1UpdateBasicOrderBodyAllBranchesItemPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
...
export const stage4ValidateOrderConfirmationBody = zod.object({
  ...
  "city": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressCityMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressCityMax).regex(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressStreetMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressStreetMax).regex(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressBuildingMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressBuildingMax).regex(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressApartmentMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressApartmentMax).regex(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressPostalCodeMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressPostalCodeMax).regex(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressFullAddressMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  ...
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientPreferencesItemKeyMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientPreferencesItemKeyMax),
  "value": zod.string().min(stage4ValidateOrderConfirmationBodyOrderSummaryClientPreferencesItemValueMin).max(stage4ValidateOrderConfirmationBodyOrderSummaryClientPreferencesItemValueMax).optional()
}).strict()).optional(),
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage4ValidateOrderConfirmationBodyOrderSummaryBranchLocationPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
...
export const stage4UpdateOrderConfirmationBody = zod.object({
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressCityMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressCityMax).regex(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressStreetMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressStreetMax).regex(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressBuildingMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressBuildingMax).regex(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressApartmentMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressApartmentMax).regex(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressPostalCodeMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressPostalCodeMax).regex(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressFullAddressMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientPreferencesItemKeyMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientPreferencesItemKeyMax),
  "value": zod.string().min(stage4UpdateOrderConfirmationBodyOrderSummaryClientPreferencesItemValueMin).max(stage4UpdateOrderConfirmationBodyOrderSummaryClientPreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage4UpdateOrderConfirmationBodyOrderSummaryBranchLocationPhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
 ...
 */
export const stage3CreateSessionBody = zod.string().uuid()

export const stage3CreateSession200Response = zod.string().uuid()
...
export const stage2StartNewItemWizard200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2StartNewItemWizard200ResponseAddedItemsItemNameMin).max(stage2StartNewItemWizard200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2StartNewItemWizard200ResponseAddedItemsItemDescriptionMin).max(stage2StartNewItemWizard200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2StartNewItemWizard200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2StartNewItemWizard200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2StartNewItemWizard200ResponseAddedItemsItemDefectsNotesMin).max(stage2StartNewItemWizard200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage2StartEditItemWizard200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2StartEditItemWizard200ResponseAddedItemsItemNameMin).max(stage2StartEditItemWizard200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2StartEditItemWizard200ResponseAddedItemsItemDescriptionMin).max(stage2StartEditItemWizard200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2StartEditItemWizard200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2StartEditItemWizard200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2StartEditItemWizard200ResponseAddedItemsItemDefectsNotesMin).max(stage2StartEditItemWizard200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage2CloseWizard200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2CloseWizard200ResponseAddedItemsItemNameMin).max(stage2CloseWizard200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2CloseWizard200ResponseAddedItemsItemDescriptionMin).max(stage2CloseWizard200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2CloseWizard200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2CloseWizard200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2CloseWizard200ResponseAddedItemsItemDefectsNotesMin).max(stage2CloseWizard200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage2SynchronizeManager200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2SynchronizeManager200ResponseAddedItemsItemNameMin).max(stage2SynchronizeManager200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2SynchronizeManager200ResponseAddedItemsItemDescriptionMin).max(stage2SynchronizeManager200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2SynchronizeManager200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2SynchronizeManager200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2SynchronizeManager200ResponseAddedItemsItemDefectsNotesMin).max(stage2SynchronizeManager200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const substep4InitializeSubstepBody = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep4InitializeSubstepBodyCharacteristicsCurrentItemDescriptionMin).max(substep4InitializeSubstepBodyCharacteristicsCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep4InitializeSubstepBodyCharacteristicsCurrentItemSpecialInstructionsMin).max(substep4InitializeSubstepBodyCharacteristicsCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep4InitializeSubstepBodyCharacteristicsCurrentItemDefectsNotesMin).max(substep4InitializeSubstepBodyCharacteristicsCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep4InitializeSubstepBodyStainsDefectsCurrentItemDescriptionMin).max(substep4InitializeSubstepBodyStainsDefectsCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep4InitializeSubstepBodyStainsDefectsCurrentItemSpecialInstructionsMin).max(substep4InitializeSubstepBodyStainsDefectsCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep4InitializeSubstepBodyStainsDefectsCurrentItemDefectsNotesMin).max(substep4InitializeSubstepBodyStainsDefectsCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
...
export const substep4CalculatePriceBody = zod.object({
  ...
  "categoryCode": zod.string().min(1).regex(substep4CalculatePriceBodyCalculationRequestCategoryCodeRegExp).describe('Код категорії послуги'),
  "itemName": zod.string().min(substep4CalculatePriceBodyCalculationRequestItemNameMin).max(substep4CalculatePriceBodyCalculationRequestItemNameMax).describe('Найменування предмету з прайс-листа'),
  "color": zod.string().max(substep4CalculatePriceBodyCalculationRequestColorMax).optional().describe('Колір предмету'),
  "quantity": zod.number().min(1).max(substep4CalculatePriceBodyCalculationRequestQuantityMax).describe('Кількість предметів'),
  "modifierCodes": zod.array(zod.string()).optional().describe('Список кодів модифікаторів для застосування'),
  "modifierIds": zod.array(zod.string()).min(substep4CalculatePriceBodyCalculationRequestModifierIdsMin).max(substep4CalculatePriceBodyCalculationRequestModifierIdsMax).optional().describe('Список ID модифікаторів для застосування'),
  "rangeModifierValues": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4CalculatePriceBodyCalculationRequestRangeModifierValuesItemModifierIdRegExp).describe('ID модифікатора'),
  "percentage": zod.number().min(substep4CalculatePriceBodyCalculationRequestRangeModifierValuesItemPercentageMin).max(substep4CalculatePriceBodyCalculationRequestRangeModifierValuesItemPercentageMax).describe('Вибраний відсоток для модифікатора')
  ...
  "modifierId": zod.string().min(1).regex(substep4CalculatePriceBodyCalculationRequestFixedModifierQuantitiesItemModifierIdRegExp).describe('ID модифікатора'),
  "quantity": zod.number().min(1).max(substep4CalculatePriceBodyCalculationRequestFixedModifierQuantitiesItemQuantityMax).describe('Кількість одиниць для модифікатора')
  ...
  "expeditePercent": zod.number().min(substep4CalculatePriceBodyCalculationRequestExpeditePercentMin).max(substep4CalculatePriceBodyCalculationRequestExpeditePercentMax).optional().describe('Відсоток надбавки за терміновість'),
  "discountPercent": zod.number().min(substep4CalculatePriceBodyCalculationRequestDiscountPercentMin).max(substep4CalculatePriceBodyCalculationRequestDiscountPercentMax).optional().describe('Відсоток знижки')
}).strict().optional().describe('Запит на розрахунок ціни предмету з модифікаторами'),
  "calculationResponse": zod.object({
  "baseUnitPrice": zod.number().min(substep4CalculatePriceBodyCalculationResponseBaseUnitPriceMin).optional().describe('Початкова базова ціна за одиницю з прайс-листа'),
  "quantity": zod.number().min(1).optional().describe('Кількість предметів'),
  "baseTotalPrice": zod.number().min(substep4CalculatePriceBodyCalculationResponseBaseTotalPriceMin).optional().describe('Сума базових цін за всі предмети без модифікаторів'),
  "unitOfMeasure": zod.enum(['шт', 'кг', 'кв.м', 'пара']).optional().describe('Одиниця виміру'),
  "finalUnitPrice": zod.number().min(substep4CalculatePriceBodyCalculationResponseFinalUnitPriceMin).optional().describe('Кінцева ціна за одиницю з урахуванням всіх модифікаторів'),
  "finalTotalPrice": zod.number().min(substep4CalculatePriceBodyCalculationResponseFinalTotalPriceMin).optional().describe('Загальна кінцева ціна за всі предмети з урахуванням всіх модифікаторів'),
  ...
  "rangeModifierValues": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4CalculatePriceBodyRangeModifierValuesItemModifierIdRegExp).describe('ID модифікатора'),
  "percentage": zod.number().min(substep4CalculatePriceBodyRangeModifierValuesItemPercentageMin).max(substep4CalculatePriceBodyRangeModifierValuesItemPercentageMax).describe('Вибраний відсоток для модифікатора')
}).strict().describe('Значення відсотка для модифікатора діапазону')).optional(),
  "fixedModifierQuantities": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4CalculatePriceBodyFixedModifierQuantitiesItemModifierIdRegExp).describe('ID модифікатора'),
  "quantity": zod.number().min(1).max(substep4CalculatePriceBodyFixedModifierQuantitiesItemQuantityMax).describe('Кількість одиниць для модифікатора')
...
export const substep4CalculatePrice200Response = zod.object({
  "baseUnitPrice": zod.number().min(substep4CalculatePrice200ResponseBaseUnitPriceMin).optional().describe('Початкова базова ціна за одиницю з прайс-листа'),
  "quantity": zod.number().min(1).optional().describe('Кількість предметів'),
  "baseTotalPrice": zod.number().min(substep4CalculatePrice200ResponseBaseTotalPriceMin).optional().describe('Сума базових цін за всі предмети без модифікаторів'),
  "unitOfMeasure": zod.enum(['шт', 'кг', 'кв.м', 'пара']).optional().describe('Одиниця виміру'),
  "finalUnitPrice": zod.number().min(substep4CalculatePrice200ResponseFinalUnitPriceMin).optional().describe('Кінцева ціна за одиницю з урахуванням всіх модифікаторів'),
  "finalTotalPrice": zod.number().min(substep4CalculatePrice200ResponseFinalTotalPriceMin).optional().describe('Загальна кінцева ціна за всі предмети з урахуванням всіх модифікаторів'),
  "calculationDetails": zod.array(zod.object({
  "step": zod.number().optional(),
  "stepName": zod.string().optional(),
  "description": zod.string().optional(),
...
export const substep3ProcessStainSelection200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3ProcessStainSelection200ResponseDataCurrentItemDescriptionMin).max(substep3ProcessStainSelection200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3ProcessStainSelection200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3ProcessStainSelection200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3ProcessStainSelection200ResponseDataCurrentItemDefectsNotesMin).max(substep3ProcessStainSelection200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep3ProcessDefectNotes200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3ProcessDefectNotes200ResponseDataCurrentItemDescriptionMin).max(substep3ProcessDefectNotes200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3ProcessDefectNotes200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3ProcessDefectNotes200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3ProcessDefectNotes200ResponseDataCurrentItemDefectsNotesMin).max(substep3ProcessDefectNotes200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep3InitializeSubstepBody = zod.object({
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3InitializeSubstepBodyDescriptionMin).max(substep3InitializeSubstepBodyDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3InitializeSubstepBodySpecialInstructionsMin).max(substep3InitializeSubstepBodySpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3InitializeSubstepBodyDefectsNotesMin).max(substep3InitializeSubstepBodyDefectsNotesMax).optional()
}).strict()
...
export const substep3InitializeSubstep200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3InitializeSubstep200ResponseDataCurrentItemDescriptionMin).max(substep3InitializeSubstep200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3InitializeSubstep200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3InitializeSubstep200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3InitializeSubstep200ResponseDataCurrentItemDefectsNotesMin).max(substep3InitializeSubstep200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep3GoBack200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3GoBack200ResponseDataCurrentItemDescriptionMin).max(substep3GoBack200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3GoBack200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3GoBack200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3GoBack200ResponseDataCurrentItemDefectsNotesMin).max(substep3GoBack200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep3ProcessDefectSelection200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3ProcessDefectSelection200ResponseDataCurrentItemDescriptionMin).max(substep3ProcessDefectSelection200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3ProcessDefectSelection200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3ProcessDefectSelection200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3ProcessDefectSelection200ResponseDataCurrentItemDefectsNotesMin).max(substep3ProcessDefectSelection200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep3CompleteSubstep200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3CompleteSubstep200ResponseDataCurrentItemDescriptionMin).max(substep3CompleteSubstep200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3CompleteSubstep200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3CompleteSubstep200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3CompleteSubstep200ResponseDataCurrentItemDefectsNotesMin).max(substep3CompleteSubstep200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep2InitializeSubstep200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep2InitializeSubstep200ResponseCurrentItemDescriptionMin).max(substep2InitializeSubstep200ResponseCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep2InitializeSubstep200ResponseCurrentItemSpecialInstructionsMin).max(substep2InitializeSubstep200ResponseCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep2InitializeSubstep200ResponseCurrentItemDefectsNotesMin).max(substep2InitializeSubstep200ResponseCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "materialSelectionCompleted": zod.boolean().optional(),
  "colorSelectionCompleted": zod.boolean().optional(),
  "fillerSelectionCompleted": zod.boolean().optional(),
...
export const stage2AddItemToOrderBody = zod.object({
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2AddItemToOrderBodyNameMin).max(stage2AddItemToOrderBodyNameMax),
  "description": zod.string().min(stage2AddItemToOrderBodyDescriptionMin).max(stage2AddItemToOrderBodyDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2AddItemToOrderBodySpecialInstructionsMin).max(stage2AddItemToOrderBodySpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2AddItemToOrderBodyDefectsNotesMin).max(stage2AddItemToOrderBodyDefectsNotesMax).optional()
}).strict()
...
export const stage2AddItemToOrder200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2AddItemToOrder200ResponseAddedItemsItemNameMin).max(stage2AddItemToOrder200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2AddItemToOrder200ResponseAddedItemsItemDescriptionMin).max(stage2AddItemToOrder200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2AddItemToOrder200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2AddItemToOrder200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2AddItemToOrder200ResponseAddedItemsItemDefectsNotesMin).max(stage2AddItemToOrder200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage2InitializeItemManager200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2InitializeItemManager200ResponseAddedItemsItemNameMin).max(stage2InitializeItemManager200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2InitializeItemManager200ResponseAddedItemsItemDescriptionMin).max(stage2InitializeItemManager200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2InitializeItemManager200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2InitializeItemManager200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2InitializeItemManager200ResponseAddedItemsItemDefectsNotesMin).max(stage2InitializeItemManager200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage2CompleteStage200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2CompleteStage200ResponseAddedItemsItemNameMin).max(stage2CompleteStage200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2CompleteStage200ResponseAddedItemsItemDescriptionMin).max(stage2CompleteStage200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2CompleteStage200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2CompleteStage200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2CompleteStage200ResponseAddedItemsItemDefectsNotesMin).max(stage2CompleteStage200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage1CreateClient200Response = zod.object({
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage1CreateClient200ResponseStructuredAddressCityMin).max(stage1CreateClient200ResponseStructuredAddressCityMax).regex(stage1CreateClient200ResponseStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage1CreateClient200ResponseStructuredAddressStreetMin).max(stage1CreateClient200ResponseStructuredAddressStreetMax).regex(stage1CreateClient200ResponseStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage1CreateClient200ResponseStructuredAddressBuildingMin).max(stage1CreateClient200ResponseStructuredAddressBuildingMax).regex(stage1CreateClient200ResponseStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage1CreateClient200ResponseStructuredAddressApartmentMin).max(stage1CreateClient200ResponseStructuredAddressApartmentMax).regex(stage1CreateClient200ResponseStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage1CreateClient200ResponseStructuredAddressPostalCodeMin).max(stage1CreateClient200ResponseStructuredAddressPostalCodeMax).regex(stage1CreateClient200ResponseStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage1CreateClient200ResponseStructuredAddressFullAddressMin).max(stage1CreateClient200ResponseStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage1CreateClient200ResponsePreferencesItemKeyMin).max(stage1CreateClient200ResponsePreferencesItemKeyMax),
  "value": zod.string().min(stage1CreateClient200ResponsePreferencesItemValueMin).max(stage1CreateClient200ResponsePreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
 ...
 */
export const stage1InitializeNewClient200Response = zod.string()
...
export const stage1SearchClients200Response = zod.object({
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage1SearchClients200ResponseClientsItemStructuredAddressCityMin).max(stage1SearchClients200ResponseClientsItemStructuredAddressCityMax).regex(stage1SearchClients200ResponseClientsItemStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage1SearchClients200ResponseClientsItemStructuredAddressStreetMin).max(stage1SearchClients200ResponseClientsItemStructuredAddressStreetMax).regex(stage1SearchClients200ResponseClientsItemStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage1SearchClients200ResponseClientsItemStructuredAddressBuildingMin).max(stage1SearchClients200ResponseClientsItemStructuredAddressBuildingMax).regex(stage1SearchClients200ResponseClientsItemStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage1SearchClients200ResponseClientsItemStructuredAddressApartmentMin).max(stage1SearchClients200ResponseClientsItemStructuredAddressApartmentMax).regex(stage1SearchClients200ResponseClientsItemStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage1SearchClients200ResponseClientsItemStructuredAddressPostalCodeMin).max(stage1SearchClients200ResponseClientsItemStructuredAddressPostalCodeMax).regex(stage1SearchClients200ResponseClientsItemStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage1SearchClients200ResponseClientsItemStructuredAddressFullAddressMin).max(stage1SearchClients200ResponseClientsItemStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage1SearchClients200ResponseClientsItemPreferencesItemKeyMin).max(stage1SearchClients200ResponseClientsItemPreferencesItemKeyMax),
  "value": zod.string().min(stage1SearchClients200ResponseClientsItemPreferencesItemValueMin).max(stage1SearchClients200ResponseClientsItemPreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage1SearchClients200ResponseFirstClientStructuredAddressCityMin).max(stage1SearchClients200ResponseFirstClientStructuredAddressCityMax).regex(stage1SearchClients200ResponseFirstClientStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage1SearchClients200ResponseFirstClientStructuredAddressStreetMin).max(stage1SearchClients200ResponseFirstClientStructuredAddressStreetMax).regex(stage1SearchClients200ResponseFirstClientStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage1SearchClients200ResponseFirstClientStructuredAddressBuildingMin).max(stage1SearchClients200ResponseFirstClientStructuredAddressBuildingMax).regex(stage1SearchClients200ResponseFirstClientStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage1SearchClients200ResponseFirstClientStructuredAddressApartmentMin).max(stage1SearchClients200ResponseFirstClientStructuredAddressApartmentMax).regex(stage1SearchClients200ResponseFirstClientStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage1SearchClients200ResponseFirstClientStructuredAddressPostalCodeMin).max(stage1SearchClients200ResponseFirstClientStructuredAddressPostalCodeMax).regex(stage1SearchClients200ResponseFirstClientStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage1SearchClients200ResponseFirstClientStructuredAddressFullAddressMin).max(stage1SearchClients200ResponseFirstClientStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage1SearchClients200ResponseFirstClientPreferencesItemKeyMin).max(stage1SearchClients200ResponseFirstClientPreferencesItemKeyMax),
  "value": zod.string().min(stage1SearchClients200ResponseFirstClientPreferencesItemValueMin).max(stage1SearchClients200ResponseFirstClientPreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
...
export const stage1SearchClientsByPhone200Response = zod.object({
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressCityMin).max(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressCityMax).regex(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressStreetMin).max(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressStreetMax).regex(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressBuildingMin).max(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressBuildingMax).regex(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressApartmentMin).max(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressApartmentMax).regex(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressPostalCodeMin).max(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressPostalCodeMax).regex(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressFullAddressMin).max(stage1SearchClientsByPhone200ResponseClientsItemStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemPreferencesItemKeyMin).max(stage1SearchClientsByPhone200ResponseClientsItemPreferencesItemKeyMax),
  "value": zod.string().min(stage1SearchClientsByPhone200ResponseClientsItemPreferencesItemValueMin).max(stage1SearchClientsByPhone200ResponseClientsItemPreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressCityMin).max(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressCityMax).regex(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressStreetMin).max(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressStreetMax).regex(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressBuildingMin).max(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressBuildingMax).regex(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressApartmentMin).max(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressApartmentMax).regex(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressPostalCodeMin).max(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressPostalCodeMax).regex(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressFullAddressMin).max(stage1SearchClientsByPhone200ResponseFirstClientStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientPreferencesItemKeyMin).max(stage1SearchClientsByPhone200ResponseFirstClientPreferencesItemKeyMax),
  "value": zod.string().min(stage1SearchClientsByPhone200ResponseFirstClientPreferencesItemValueMin).max(stage1SearchClientsByPhone200ResponseFirstClientPreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
 ...
 */
export const stage1InitializeClientSearch200Response = zod.string()
 ...
 */
export const stage1StartBasicOrderWorkflow200Response = zod.string()
...
export const stage1GenerateReceiptNumber200Response = zod.string()
 ...
 */
export const stage1InitializeBasicOrder200Response = zod.string()
...
export const stage3IsStageReady200Response = zod.boolean()
...
export const stage3GetSessionProgress200Response = zod.number()
...
export const stage3IsPaymentConfigReady200Response = zod.boolean()
...
export const stage3IsExecutionParamsReady200Response = zod.boolean()
...
export const stage3IsDiscountConfigReady200Response = zod.boolean()
...
export const stage3GetSessionContext200Response = zod.object({
  ...
  "orderId": zod.string().uuid(),
  "discountType": zod.enum(['NO_DISCOUNT', 'EVERCARD', 'SOCIAL_MEDIA', 'MILITARY', 'CUSTOM']),
  "discountPercentage": zod.number().min(stage3GetSessionContext200ResponseDiscountConfigurationDiscountRequestDiscountPercentageMin).max(stage3GetSessionContext200ResponseDiscountConfigurationDiscountRequestDiscountPercentageMax).optional(),
  "discountDescription": zod.string().min(stage3GetSessionContext200ResponseDiscountConfigurationDiscountRequestDiscountDescriptionMin).max(stage3GetSessionContext200ResponseDiscountConfigurationDiscountRequestDiscountDescriptionMax).optional()
}).strict().optional(),
  "discountResponse": zod.object({
  "orderId": zod.string().uuid().optional(),
  "discountType": zod.enum(['NO_DISCOUNT', 'EVERCARD', 'SOCIAL_MEDIA', 'MILITARY', 'CUSTOM']).optional(),
  ...
  "orderId": zod.string().uuid(),
  "paymentMethod": zod.enum(['TERMINAL', 'CASH', 'BANK_TRANSFER']),
  "prepaymentAmount": zod.number().min(stage3GetSessionContext200ResponsePaymentConfigurationPaymentRequestPrepaymentAmountMin).optional()
}).strict().optional(),
  "paymentResponse": zod.object({
  "orderId": zod.string().uuid().optional(),
  "paymentMethod": zod.enum(['TERMINAL', 'CASH', 'BANK_TRANSFER']).optional(),
  ...
  "additionalInfoRequest": zod.object({
  "orderId": zod.string().uuid(),
  "additionalRequirements": zod.string().min(stage3GetSessionContext200ResponseAdditionalInfoAdditionalInfoRequestAdditionalRequirementsMin).max(stage3GetSessionContext200ResponseAdditionalInfoAdditionalInfoRequestAdditionalRequirementsMax).optional(),
  "customerNotes": zod.string().min(stage3GetSessionContext200ResponseAdditionalInfoAdditionalInfoRequestCustomerNotesMin).max(stage3GetSessionContext200ResponseAdditionalInfoAdditionalInfoRequestCustomerNotesMax).optional()
}).strict().optional(),
  "additionalInfoResponse": zod.object({
  "orderId": zod.string().uuid().optional(),
  "additionalRequirements": zod.string().optional(),
...
export const stage3IsAdditionalInfoReady200Response = zod.boolean()
...
export const substep4ValidateCurrentState200Response = zod.boolean()
...
export const substep4SessionExists200Response = zod.boolean()
...
export const substep4GetCurrentData200Response = zod.object({
  "calculationRequest": zod.object({
  "categoryCode": zod.string().min(1).regex(substep4GetCurrentData200ResponseCalculationRequestCategoryCodeRegExp).describe('Код категорії послуги'),
  "itemName": zod.string().min(substep4GetCurrentData200ResponseCalculationRequestItemNameMin).max(substep4GetCurrentData200ResponseCalculationRequestItemNameMax).describe('Найменування предмету з прайс-листа'),
  "color": zod.string().max(substep4GetCurrentData200ResponseCalculationRequestColorMax).optional().describe('Колір предмету'),
  "quantity": zod.number().min(1).max(substep4GetCurrentData200ResponseCalculationRequestQuantityMax).describe('Кількість предметів'),
  "modifierCodes": zod.array(zod.string()).optional().describe('Список кодів модифікаторів для застосування'),
  "modifierIds": zod.array(zod.string()).min(substep4GetCurrentData200ResponseCalculationRequestModifierIdsMin).max(substep4GetCurrentData200ResponseCalculationRequestModifierIdsMax).optional().describe('Список ID модифікаторів для застосування'),
  "rangeModifierValues": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4GetCurrentData200ResponseCalculationRequestRangeModifierValuesItemModifierIdRegExp).describe('ID модифікатора'),
  "percentage": zod.number().min(substep4GetCurrentData200ResponseCalculationRequestRangeModifierValuesItemPercentageMin).max(substep4GetCurrentData200ResponseCalculationRequestRangeModifierValuesItemPercentageMax).describe('Вибраний відсоток для модифікатора')
  ...
  "fixedModifierQuantities": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4GetCurrentData200ResponseCalculationRequestFixedModifierQuantitiesItemModifierIdRegExp).describe('ID модифікатора'),
  "quantity": zod.number().min(1).max(substep4GetCurrentData200ResponseCalculationRequestFixedModifierQuantitiesItemQuantityMax).describe('Кількість одиниць для модифікатора')
  ...
  "expedited": zod.boolean().optional().describe('Чи термінове замовлення'),
  "expeditePercent": zod.number().min(substep4GetCurrentData200ResponseCalculationRequestExpeditePercentMin).max(substep4GetCurrentData200ResponseCalculationRequestExpeditePercentMax).optional().describe('Відсоток надбавки за терміновість'),
  "discountPercent": zod.number().min(substep4GetCurrentData200ResponseCalculationRequestDiscountPercentMin).max(substep4GetCurrentData200ResponseCalculationRequestDiscountPercentMax).optional().describe('Відсоток знижки')
}).strict().optional().describe('Запит на розрахунок ціни предмету з модифікаторами'),
  "calculationResponse": zod.object({
  "baseUnitPrice": zod.number().min(substep4GetCurrentData200ResponseCalculationResponseBaseUnitPriceMin).optional().describe('Початкова базова ціна за одиницю з прайс-листа'),
  "quantity": zod.number().min(1).optional().describe('Кількість предметів'),
  "baseTotalPrice": zod.number().min(substep4GetCurrentData200ResponseCalculationResponseBaseTotalPriceMin).optional().describe('Сума базових цін за всі предмети без модифікаторів'),
  "unitOfMeasure": zod.enum(['шт', 'кг', 'кв.м', 'пара']).optional().describe('Одиниця виміру'),
  "finalUnitPrice": zod.number().min(substep4GetCurrentData200ResponseCalculationResponseFinalUnitPriceMin).optional().describe('Кінцева ціна за одиницю з урахуванням всіх модифікаторів'),
  "finalTotalPrice": zod.number().min(substep4GetCurrentData200ResponseCalculationResponseFinalTotalPriceMin).optional().describe('Загальна кінцева ціна за всі предмети з урахуванням всіх модифікаторів'),
  "calculationDetails": zod.array(zod.object({
  "step": zod.number().optional(),
  "stepName": zod.string().optional(),
  "description": zod.string().optional(),
  ...
  "selectedModifierIds": zod.array(zod.string()).optional(),
  "rangeModifierValues": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4GetCurrentData200ResponseRangeModifierValuesItemModifierIdRegExp).describe('ID модифікатора'),
  "percentage": zod.number().min(substep4GetCurrentData200ResponseRangeModifierValuesItemPercentageMin).max(substep4GetCurrentData200ResponseRangeModifierValuesItemPercentageMax).describe('Вибраний відсоток для модифікатора')
}).strict().describe('Значення відсотка для модифікатора діапазону')).optional(),
  "fixedModifierQuantities": zod.array(zod.object({
  "modifierId": zod.string().min(1).regex(substep4GetCurrentData200ResponseFixedModifierQuantitiesItemModifierIdRegExp).describe('ID модифікатора'),
  "quantity": zod.number().min(1).max(substep4GetCurrentData200ResponseFixedModifierQuantitiesItemQuantityMax).describe('Кількість одиниць для модифікатора')
}).strict().describe('Кількість для модифікатора з фіксованою ціною')).optional(),
  "calculationNotes": zod.string().optional(),
  "calculationCompleted": zod.boolean().optional(),
  "hasCalculationErrors": zod.boolean().optional(),
 ...
 */
export const substep3GetAvailableStainTypes200ResponseItem = zod.string()
 ...
 */
export const substep3GetAvailableDefectTypes200ResponseItem = zod.string()
...
export const substep3GetContext200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep3GetContext200ResponseDataCurrentItemDescriptionMin).max(substep3GetContext200ResponseDataCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep3GetContext200ResponseDataCurrentItemSpecialInstructionsMin).max(substep3GetContext200ResponseDataCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep3GetContext200ResponseDataCurrentItemDefectsNotesMin).max(substep3GetContext200ResponseDataCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "stainsSelectionCompleted": zod.boolean().optional(),
  "defectsSelectionCompleted": zod.boolean().optional(),
  "dataValid": zod.boolean().optional(),
...
export const substep2GetAvailableMaterials200ResponseItem = zod.string()
...
export const substep2GetCurrentCharacteristics200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "description": zod.string().min(substep2GetCurrentCharacteristics200ResponseCurrentItemDescriptionMin).max(substep2GetCurrentCharacteristics200ResponseCurrentItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(substep2GetCurrentCharacteristics200ResponseCurrentItemSpecialInstructionsMin).max(substep2GetCurrentCharacteristics200ResponseCurrentItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(substep2GetCurrentCharacteristics200ResponseCurrentItemDefectsNotesMin).max(substep2GetCurrentCharacteristics200ResponseCurrentItemDefectsNotesMax).optional()
}).strict().optional(),
  "materialSelectionCompleted": zod.boolean().optional(),
  "colorSelectionCompleted": zod.boolean().optional(),
  "fillerSelectionCompleted": zod.boolean().optional(),
 ...
 */
export const stage2GetActiveSessionCount200Response = zod.number()
...
export const stage2CheckReadinessToProceed200Response = zod.boolean()
...
export const stage2GetCurrentManager200Response = zod.object({
  ...
  "id": zod.string().uuid().optional(),
  "orderId": zod.string().uuid().optional(),
  "name": zod.string().min(stage2GetCurrentManager200ResponseAddedItemsItemNameMin).max(stage2GetCurrentManager200ResponseAddedItemsItemNameMax),
  "description": zod.string().min(stage2GetCurrentManager200ResponseAddedItemsItemDescriptionMin).max(stage2GetCurrentManager200ResponseAddedItemsItemDescriptionMax).optional(),
  "quantity": zod.number().min(1),
  "unitPrice": zod.number(),
  "totalPrice": zod.number().optional(),
  "category": zod.string().optional(),
  ...
  "unitOfMeasure": zod.string().optional(),
  "defects": zod.string().optional(),
  "specialInstructions": zod.string().min(stage2GetCurrentManager200ResponseAddedItemsItemSpecialInstructionsMin).max(stage2GetCurrentManager200ResponseAddedItemsItemSpecialInstructionsMax).optional(),
  "fillerType": zod.string().optional(),
  "fillerCompressed": zod.boolean().optional(),
  "wearDegree": zod.string().optional(),
  "stains": zod.string().optional(),
  ...
  "defectsAndRisks": zod.string().optional(),
  "noGuaranteeReason": zod.string().optional(),
  "defectsNotes": zod.string().min(stage2GetCurrentManager200ResponseAddedItemsItemDefectsNotesMin).max(stage2GetCurrentManager200ResponseAddedItemsItemDefectsNotesMax).optional()
}).strict()).optional(),
  "totalAmount": zod.number().optional(),
  "itemCount": zod.number().optional(),
  "canProceedToNextStage": zod.boolean().optional(),
...
export const stage1GetSelectedClient200Response = zod.object({
  ...
  "address": zod.string().optional(),
  "structuredAddress": zod.object({
  "city": zod.string().min(stage1GetSelectedClient200ResponseStructuredAddressCityMin).max(stage1GetSelectedClient200ResponseStructuredAddressCityMax).regex(stage1GetSelectedClient200ResponseStructuredAddressCityRegExp).optional(),
  "street": zod.string().min(stage1GetSelectedClient200ResponseStructuredAddressStreetMin).max(stage1GetSelectedClient200ResponseStructuredAddressStreetMax).regex(stage1GetSelectedClient200ResponseStructuredAddressStreetRegExp).optional(),
  "building": zod.string().min(stage1GetSelectedClient200ResponseStructuredAddressBuildingMin).max(stage1GetSelectedClient200ResponseStructuredAddressBuildingMax).regex(stage1GetSelectedClient200ResponseStructuredAddressBuildingRegExp).optional(),
  "apartment": zod.string().min(stage1GetSelectedClient200ResponseStructuredAddressApartmentMin).max(stage1GetSelectedClient200ResponseStructuredAddressApartmentMax).regex(stage1GetSelectedClient200ResponseStructuredAddressApartmentRegExp).optional(),
  "postalCode": zod.string().min(stage1GetSelectedClient200ResponseStructuredAddressPostalCodeMin).max(stage1GetSelectedClient200ResponseStructuredAddressPostalCodeMax).regex(stage1GetSelectedClient200ResponseStructuredAddressPostalCodeRegExp).optional(),
  "fullAddress": zod.string().min(stage1GetSelectedClient200ResponseStructuredAddressFullAddressMin).max(stage1GetSelectedClient200ResponseStructuredAddressFullAddressMax).optional()
}).strict().optional(),
  "communicationChannels": zod.array(zod.enum(['PHONE', 'SMS', 'VIBER'])).optional(),
  "source": zod.enum(['INSTAGRAM', 'GOOGLE', 'RECOMMENDATION', 'OTHER']).optional(),
  "sourceDetails": zod.string().optional(),
  ...
  "preferences": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "key": zod.string().min(stage1GetSelectedClient200ResponsePreferencesItemKeyMin).max(stage1GetSelectedClient200ResponsePreferencesItemKeyMax),
  "value": zod.string().min(stage1GetSelectedClient200ResponsePreferencesItemValueMin).max(stage1GetSelectedClient200ResponsePreferencesItemValueMax).optional()
}).strict()).optional(),
  "recentOrders": zod.array(zod.object({
  "id": zod.string().uuid().optional(),
  "receiptNumber": zod.string().optional(),
...
export const stage1GetBranchesForSession200ResponseItem = zod.object({
  ...
  "name": zod.string().min(1),
  "address": zod.string().min(1),
  "phone": zod.string().regex(stage1GetBranchesForSession200ResponsePhoneRegExp).optional(),
  "code": zod.string().min(1),
  "active": zod.boolean().optional(),
  "createdAt": zod.string().datetime({}).optional(),
  "updatedAt": zod.string().datetime({}).optional()
...
export const stage1AreBranchesLoaded200Response = zod.boolean()
