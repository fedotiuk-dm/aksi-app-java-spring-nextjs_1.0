...
export const getOrderByNumber = (
 ...
 options?: SecondParameter<typeof orvalFetcher>,signal?: AbortSignal
      ...
      return orvalFetcher<OrderInfo>(
      {url: `/api/orders/by-number/${orderNumber}`, method: 'GET', signal
    },
      options);
    }
...
export const getGetOrderByNumberQueryKey = (orderNumber?: string,) => {
    return [`/api/orders/by-number/${orderNumber}`] as const;
    }

    
export const getGetOrderByNumberQueryOptions = <TData = Awaited<ReturnType<typeof getOrderByNumber>>, TError = ErrorResponse | ErrorResponse>(orderNumber: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderByNumber>>, TError, TData>>, request?: SecondParameter<typeof orvalFetcher>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetOrderByNumberQueryKey(orderNumber);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getOrderByNumber>>> = ({ signal }) => getOrderByNumber(orderNumber, requestOptions, signal);

      

      

   return  { queryKey, queryFn, enabled: !!(orderNumber), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getOrderByNumber>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetOrderByNumberQueryResult = NonNullable<Awaited<ReturnType<typeof getOrderByNumber>>>
export type GetOrderByNumberQueryError = ErrorResponse | ErrorResponse


export function useGetOrderByNumber<TData = Awaited<ReturnType<typeof getOrderByNumber>>, TError = ErrorResponse | ErrorResponse>(
 orderNumber: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderByNumber>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetOrderByNumber<TData = Awaited<ReturnType<typeof getOrderByNumber>>, TError = ErrorResponse | ErrorResponse>(
 orderNumber: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderByNumber>>, TError, TData>>, request?: SecondParameter<typeof orvalFetcher>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get order by order number
