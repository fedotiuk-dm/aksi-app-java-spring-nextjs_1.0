...
export const listOrdersQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
...
export const listOrdersQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(listOrdersQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
...
export const getOverdueOrdersQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
...
export const getOverdueOrdersQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(getOverdueOrdersQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
...
export const getOrdersDueForCompletionQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
...
export const getOrdersDueForCompletionQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(getOrdersDueForCompletionQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
...
export const getCustomerOrderHistoryQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
...
export const getCustomerOrderHistoryQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(getCustomerOrderHistoryQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
