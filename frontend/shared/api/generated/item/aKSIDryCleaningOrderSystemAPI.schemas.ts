...
active?: boolean;
/**
 * Фільтр по батьківській категорії
 */
parentId?: string;
};

export type GetPriceModifiersParams = {
/**
 * Фільтр по категорії
 */
categoryId?: string;
...
export type GetCategoryItemsParams = {
/**
 * Фільтр по активності
 */
active?: boolean;
...
export type SearchPriceListItemsParams = {
/**
 * Пошуковий запит
 * @minLength 2
 * @maxLength 2147483647
...
export type DownloadPhotoFileParams = {
/**
 * Чи повернути мініатюру
 */
thumbnail?: boolean;
};
