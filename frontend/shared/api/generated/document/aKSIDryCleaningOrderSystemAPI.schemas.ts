...
export type GetReceiptPdfParams = {
/**
 * Шаблон квитанції
 */
template?: GetReceiptPdfTemplate;
};

export type GetReceiptPdfTemplate = typeof GetReceiptPdfTemplate[keyof typeof GetReceiptPdfTemplate];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetReceiptPdfTemplate = {
  STANDARD: 'STANDARD',
  COMPACT: 'COMPACT',
  DETAILED: 'DETAILED',
} as const;

export type GetQrCodeByIdParams = {
/**
 * Формат зображення
 */
format?: GetQrCodeByIdFormat;
/**
...
export type GetQrCodeByIdFormat = typeof GetQrCodeByIdFormat[keyof typeof GetQrCodeByIdFormat];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetQrCodeByIdFormat = {
  PNG: 'PNG',
  SVG: 'SVG',
  JPEG: 'JPEG',
} as const;
...
/**
 * Фільтр за статусом документа
 */
status?: GetDocumentsStatus;
/**
 * Фільтр за пов'язаною сутністю
 */
relatedEntityId?: string;
/**
 * Початкова дата
...
size?: number;
/**
 * Параметри сортування (field,direction)
 */
sort?: string;
};

export type GetDocumentsType = typeof GetDocumentsType[keyof typeof GetDocumentsType];
...
export type GetDocumentsStatus = typeof GetDocumentsStatus[keyof typeof GetDocumentsStatus];
...
export type GetDigitalSignatureImageParams = {
/**
 * Формат зображення
 */
format?: string;
