...
city?: string;
/**
 * Включити неактивні філії
 */
includeInactive?: boolean;
};

export type GetBranchStatisticsParams = {
/**
...
export type GetBranchNextWorkingDayParams = {
/**
 * Дата від якої шукати (ISO 8601 date)
 */
fromDate?: string;
};

export type GetBranchOpenStatusParams = {
/**
 * Дата та час для перевірки (ISO 8601)
 */
dateTime?: string;
};

export type CompareBranchStatisticsParams = {
/**
 * Початкова дата періоду
 */
startDate: string;
...
export type GetNearbyBranchesParams = {
/**
 * Широта
 * @minimum -90
 * @maximum 90
