...
export const updatePriceModifierBody = zod.object({
  ...
  "operation": zod.enum(['ADD', 'SUBTRACT', 'MULTIPLY', 'DIVIDE']).optional().describe('Operation type for applying the modifier'),
 ...
 */
export const listPriceModifiersQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
...
export const listPriceModifiersQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(listPriceModifiersQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
 ...
 */
export const listDiscountsQueryActiveDefault = true;export const listDiscountsQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
export const listDiscountsQuerySortOrderDefault = "ASC";
...
export const listDiscountsQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(listDiscountsQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
