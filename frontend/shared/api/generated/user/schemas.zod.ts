...
export const listUsersQuerySortByRegExp = new RegExp('^[a-zA-Z0-9\\s.,!?-]{1,255}$');
...
export const listUsersQueryParams = zod.object({
  ...
  "sortBy": zod.string().regex(listUsersQuerySortByRegExp).optional().describe('Field to sort by (domain-specific). If not provided, server default is used'),
