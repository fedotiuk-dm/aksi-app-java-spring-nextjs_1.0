...
export function getModifierTypeDisplayName(type: string): string {
  const displayNames: Record<string, string> = {
    ...
    // Модифікатори для текстилю
    [PriceModifierType.FUR_COLLARS]:
      'Чистка виробів з хутряними комірами та манжетами',
    [PriceModifierType.WATERPROOF_COATING_TEXTILE]:
      'Нанесення водовідштовхуючого покриття',
    [PriceModifierType.SILK_SATIN_CHIFFON]:
      'Чистка виробів із натурального шовку, атласу, шифону',
    [PriceModifierType.COMBINED_LEATHER_TEXTILE]:
    ...
    [PriceModifierType.BLACK_LIGHT_COLORS]:
 ...
 */
export function isModifierApplicableToCategory(
