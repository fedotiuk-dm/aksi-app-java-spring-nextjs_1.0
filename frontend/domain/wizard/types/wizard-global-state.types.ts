 ...
 *
 * ВАЖЛИВО: WizardMachineContext тепер в machines/machine-types.ts для XState v5
 */

import { WizardContext } from './wizard-context.types';
import { SaveState } from './wizard-save-state.types';
import { WizardStepState } from './wizard-step-state.types';
import { WizardStep, ItemWizardStep } from './wizard-steps.types';
