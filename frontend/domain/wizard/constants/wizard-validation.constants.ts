/**
 * @fileoverview Константи валідації wizard
 * @module domain/wizard/constants/wizard-validation
 *
 * Відповідальність: управління валідаційними правилами та обмеженнями
