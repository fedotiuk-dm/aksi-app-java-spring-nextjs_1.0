...
export class Substep3ApiService {
    /**
     * Обробка вибору плям
     * @returns StainsDefectsContext OK
     * @throws ApiError
     */
    public static processStainSelection({
        sessionId,
        selectedStains,
        otherStains,
    }: {
     ...
     * @throws ApiError
     */
    public static processDefectNotes({
        sessionId,
        defectNotes,
    }: {
        sessionId: string,
     ...
     * @throws ApiError
     */
    public static initializeSubstep3({
        sessionId,
        requestBody,
    }: {
        sessionId: string,
     ...
     * @throws ApiError
     */
    public static processDefectSelection({
        sessionId,
        selectedDefects,
        noGuaranteeReason,
    }: {
     ...
     * @throws ApiError
     */
    public static completeSubstep3({
        sessionId,
    }: {
        sessionId: string,
    }): CancelablePromise<StainsDefectsContext> {
     ...
     * @throws ApiError
     */
    public static getAvailableStainTypes(): CancelablePromise<Array<string>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getAvailableDefectTypes(): CancelablePromise<Array<string>> {
        return __request(OpenAPI, {
            method: 'GET',
