...
export class Substep1ApiService {
    /**
     * Валідує та завершує підетап 1
     * @returns ItemBasicInfoDTO OK
     * @throws ApiError
     */
    public static validateAndCompleteSubstep1({
        sessionId,
    }: {
        sessionId: string,
     ...
     * @throws ApiError
     */
    public static selectPriceListItem({
        sessionId,
        itemId,
    }: {
        sessionId: string,
     ...
     * @throws ApiError
     */
    public static selectServiceCategory({
        sessionId,
        categoryId,
    }: {
        sessionId: string,
     ...
     * @throws ApiError
     */
    public static startSubstep1(): CancelablePromise<ItemBasicInfoDTO> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getSubstep1Status({
        sessionId,
    }: {
        sessionId: string,
     ...
     * @throws ApiError
     */
    public static getServiceCategories(): CancelablePromise<Array<ServiceCategoryDTO>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getItemsForCategory({
        categoryId,
    }: {
        categoryId: string,
     ...
     * @throws ApiError
     */
    public static finalizeSubstep1Session({
        sessionId,
    }: {
        sessionId: string,
