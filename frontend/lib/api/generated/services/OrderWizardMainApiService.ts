...
export class OrderWizardMainApiService {
     ...
     * @throws ApiError
     */
    public static orderWizardClientSelected({
        sessionId,
    }: {
        sessionId: string,
    }): CancelablePromise<OrderWizardResponseDTO> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/order-wizard/session/{sessionId}/client-selected',
            path: {
                'sessionId': sessionId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static orderWizardClearAllSessions(): CancelablePromise<Record<string, any>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/order-wizard/clear-all-sessions',
            errors: {
                400: `Bad Request`,
                401: `Unauthorized`,
                403: `Forbidden`,
