...
**Ключові сутності**:
- `ServiceCategoryType` - категорія послуги  
- `ServiceCatalog` - конкретна послуга
- `ItemCatalog` - предмет з прайс-листа
...
- Cart використовує Catalog для отримання базових цін
...
1. **Catalog Domain вже об'єднує каталог:**
   - ServiceCatalog - категорії послуг
   - ItemCatalog - предмети з прайс-листа
