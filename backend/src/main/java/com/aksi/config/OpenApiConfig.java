 ...
 *
 * Система включає 5 основних доменів:
 * - Client: управління клієнтами
 * - Order: управління замовленнями
 * - Item: управління предметами та послугами
 * - Branch: управління філіями
 * - Document: генерація документів та квитанцій
 */
@Configuration
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API для односторінкової системи замовлень хімчистки з DDD архітектурою")
                        .version("1.0.0")
                        .contact(new Contact()
