...
/**
 * HTTP Controller для ReceiptsApi
...
public class ReceiptsApiController implements ReceiptsApi {
    ...
    private final DocumentService documentService;
        ...
        @Override
    public ResponseEntity<ReceiptResponse> createReceipt(GenerateReceiptRequest generateReceiptRequest) {
    ...
    @Override
    public ResponseEntity<ReceiptResponse> updateReceipt(UUID id, UpdateReceiptRequest updateReceiptRequest) {
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).build();
    }
}
