...
public class PriceListApiController implements PriceListApi {
    ...
    @Override
    public ResponseEntity<PriceListItemResponse> createPriceListItem(CreatePriceListItemRequest request) {
    ...
    @Override
    public ResponseEntity<PriceListPageResponse> getPriceList(Integer page, Integer size, String sort, UUID categoryId, String search, Boolean active) {
        var response = priceListItemService.getPriceListWithPagination(page, size, sort, categoryId, search, active);
    ...
    @Override
    public ResponseEntity<List<PriceListItemResponse>> searchPriceListItems(String query, UUID categoryId, Integer limit) {
        var response = priceListItemService.searchPriceListItems(query, categoryId, limit);
        return ResponseEntity.ok(response);
    }

    @Override
    public ResponseEntity<PriceListItemResponse> updatePriceListItem(UUID id, UpdatePriceListItemRequest request) {
