...
/**
 * Результат валідації у функціональному стилі. Замінює immediate exceptions на композиційний
 * підхід.
 *
...
public record ValidationResult(boolean isValid, List<String> errors) {
  ...
  /**
   * Альтернативна валідація (OR логіка). Якщо хоча б один результат валідний - повертаємо valid().
   */
  ...
  public ValidationResult not() {
    return this.isValid ? invalid("Validation should have failed") : valid();
  }
