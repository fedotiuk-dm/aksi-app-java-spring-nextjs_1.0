...
/**
 * Базова MapStruct конфігурація з загальними маппінгами Використовується всіма доменними мапперами
 * для уникнення дублювання Автоматично ігнорує BaseEntity поля (id, createdAt, updatedAt, version).
 */
