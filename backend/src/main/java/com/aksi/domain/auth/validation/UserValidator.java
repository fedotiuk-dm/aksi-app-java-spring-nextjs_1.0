...
/**
 * Валідатор для бізнес-правил користувачів
 * Тільки бізнес-логіка, Bean Validation (@NotNull, @Size, @Pattern, @Email) в OpenAPI
 */
@Component
public class UserValidator {

    /**
     * Валідація користувача для створення
     * Тільки бізнес-правила
     */
    ...
    /**
     * Валідація користувача для оновлення
     * Тільки бізнес-правила
     */
     ...
     * Аналог normalizePhone в ClientValidator
     */
    ...
    private void validateRoles(UserEntity user, Map<String, List<String>> errors) {
        if (user.getRoles() == null || user.getRoles().isEmpty()) {
            errors.computeIfAbsent("roles", k -> new ArrayList<>())
