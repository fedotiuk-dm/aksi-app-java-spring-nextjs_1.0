...
public class OrderItemEntity extends BaseEntity {
    ...
    public void applyTextileModifier(String name, int percentage, String description) {
        if (!category.allowsTextileModifiers()) {
            throw new IllegalStateException("Категорія " + category + " не підтримує текстильні модифікатори");
        }

        OrderItemModifierEntity modifier = OrderItemModifierEntity.createTextileModifier(name, percentage, description);
    ...
    public void applyLeatherModifier(String name, int percentage, String description) {
        if (!category.allowsLeatherModifiers()) {
            throw new IllegalStateException("Категорія " + category + " не підтримує шкіряні модифікатори");
        }

        OrderItemModifierEntity modifier = OrderItemModifierEntity.createLeatherModifier(name, percentage, description);
        addModifier(modifier);
    }
    ...
    public void applyFixedModifier(String name, BigDecimal amount, String description) {
        OrderItemModifierEntity modifier = OrderItemModifierEntity.createFixedModifier(name, amount, description);
        addModifier(modifier);
    }
}
