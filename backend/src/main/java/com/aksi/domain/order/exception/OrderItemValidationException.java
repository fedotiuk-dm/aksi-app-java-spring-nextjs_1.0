...
public class OrderItemValidationException extends RuntimeException {
     ...
     */
    public static OrderItemValidationException incompatibleMaterialWithCategory(String material, String category) {
     ...
     */
    public static OrderItemValidationException incompatibleStainWithMaterial(String stain, String material) {
        return new OrderItemValidationException(
     ...
     */
    public static OrderItemValidationException incompatibleDefectWithCategory(String defect, String category) {
        return new OrderItemValidationException(
    ...
    public static OrderItemValidationException invalidPrice(String reason) {
        return new OrderItemValidationException(
            "Некоректна ціна предмету: " + reason
        );
    }
