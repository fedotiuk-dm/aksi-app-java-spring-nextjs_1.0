...
public class DiscountValidationException extends RuntimeException {
     ...
     */
    public static DiscountValidationException invalidPercentage(BigDecimal percentage, String discountType) {
     ...
     */
    public static DiscountValidationException percentageExceedsLimit(BigDecimal percentage, BigDecimal maxAllowed) {
        return new DiscountValidationException(
            String.format("Відсоток знижки %s перевищує максимально дозволений %s", percentage, maxAllowed)
        );
    }
     ...
     */
    public static DiscountValidationException cannotCombineDiscounts(String discount1, String discount2) {
        return new DiscountValidationException(
