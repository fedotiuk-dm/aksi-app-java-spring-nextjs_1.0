...
public class ClientSearchValidGuard implements Guard<ClientSearchState, ClientSearchEvent> {
    ...
    public ClientSearchValidGuard(ClientSearchCoordinationService coordinationService) {
    ...
    public boolean evaluate(StateContext<ClientSearchState, ClientSearchEvent> context) {
        ...
        // Використовуємо CoordinationService для перевірки валідності критеріїв
        return coordinationService.areSearchCriteriaValid(sessionId);
    }
}
