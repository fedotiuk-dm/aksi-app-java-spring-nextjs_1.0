...
public class OrderNotFoundException extends RuntimeException {
    ...
    public static OrderNotFoundException byReceiptNumber(String receiptNumber) {
        return new OrderNotFoundException("Замовлення з номером квитанції " + receiptNumber + " не знайдено");
    }

    public static OrderNotFoundException byUniqueTag(String uniqueTag) {
        return new OrderNotFoundException("Замовлення з унікальною міткою " + uniqueTag + " не знайдено");
    }
