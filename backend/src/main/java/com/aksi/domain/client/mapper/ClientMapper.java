...
public interface ClientMapper {
     ...
     */
    @Mapping(target = "registrationDate", source = "createdAt", qualifiedByName = "localDateTimeToLocalDate")
     ...
     */
    default Set<CommunicationMethodType> toCommunicationMethodTypeSet(List<CommunicationMethod> dtoList) {
        if (dtoList == null) return null;
        return dtoList.stream()
            .map(this::toCommunicationMethodType)
     ...
     */
    default List<CommunicationMethod> toCommunicationMethodList(Set<CommunicationMethodType> entitySet) {
        if (entitySet == null) return null;
        return entitySet.stream()
            .map(this::toCommunicationMethod)
