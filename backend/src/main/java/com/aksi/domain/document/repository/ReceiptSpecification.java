...
public class ReceiptSpecification {
    ...
    public static Specification<ReceiptEntity> hasDocumentId(Long documentId) {
        return (root, query, criteriaBuilder) ->
            documentId == null ? null : criteriaBuilder.equal(root.get("document").get("id"), documentId);
    }
    ...
    public static Specification<ReceiptEntity> isPrinted() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isNotNull(root.get("printedAt"));
    }

    public static Specification<ReceiptEntity> isNotPrinted() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isNull(root.get("printedAt"));
    }

    public static Specification<ReceiptEntity> printedAfter(LocalDateTime dateTime) {
        return (root, query, criteriaBuilder) ->
            dateTime == null ? null : criteriaBuilder.greaterThanOrEqualTo(root.get("printedAt"), dateTime);
    }
    ...
    public static Specification<ReceiptEntity> hasNoSignatures() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isEmpty(root.get("digitalSignatures"));
    }
    ...
    public static Specification<ReceiptEntity> hasClientSignature() {
        return (root, query, criteriaBuilder) -> {
            ...
            return criteriaBuilder.or(
                criteriaBuilder.equal(signatureJoin.get("type"), com.aksi.domain.document.enums.SignatureType.CLIENT_HANDOVER),
                criteriaBuilder.equal(signatureJoin.get("type"), com.aksi.domain.document.enums.SignatureType.CLIENT_PICKUP)
            );
        };
    }
    ...
    public static Specification<ReceiptEntity> hasOperatorSignature() {
        return (root, query, criteriaBuilder) -> {
            var signatureJoin = root.join("digitalSignatures");
            return criteriaBuilder.equal(signatureJoin.get("type"), com.aksi.domain.document.enums.SignatureType.OPERATOR);
        };
    }
    ...
    public static Specification<ReceiptEntity> readyForPrinting() {
        return Specification.where(isNotPrinted())
            .and(hasQrCode())
            .and(hasSigned());
    }

    public static Specification<ReceiptEntity> readyForSigning() {
        return Specification.where(hasNoSignatures())
            .and(hasQrCode());
    }

    public static Specification<ReceiptEntity> fullyProcessed() {
        return Specification.where(isPrinted())
            .and(hasClientSignature())
            .and(hasOperatorSignature());
    }
    ...
    // Complex queries
    public static Specification<ReceiptEntity> searchReceipts(UUID orderId,
                                                            String templateName,
                                                            Boolean isPrinted) {
    ...
    public static Specification<ReceiptEntity> auditQuery(LocalDateTime from,
                                                        LocalDateTime to,
                                                        Boolean hasPrintedStatus) {
