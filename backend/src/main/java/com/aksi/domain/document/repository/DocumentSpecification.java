...
public class DocumentSpecification {
  ...
  public static Specification<DocumentEntity> hasRelatedEntityId(UUID relatedEntityId) {
    return (root, query, criteriaBuilder) ->
        relatedEntityId == null
            ? null
            : criteriaBuilder.equal(root.get("relatedEntityId"), relatedEntityId);
  }
  ...
  public static Specification<DocumentEntity> createdByContains(String createdBy) {
    return (root, query, criteriaBuilder) ->
        createdBy == null
            ? null
            : criteriaBuilder.like(
                criteriaBuilder.lower(root.get("createdBy")), "%" + createdBy.toLowerCase() + "%");
  }
  ...
  public static Specification<DocumentEntity> mimeTypeStartsWith(String prefix) {
    return (root, query, criteriaBuilder) ->
        prefix == null ? null : criteriaBuilder.like(root.get("mimeType"), prefix + "%");
  }
  ...
  public static Specification<DocumentEntity> isCompleted() {
    return hasStatusIn(
        List.of(DocumentStatus.SIGNED, DocumentStatus.PRINTED, DocumentStatus.ARCHIVED));
  }
  ...
  public static Specification<DocumentEntity> searchDocuments(
      String documentNumber, DocumentType type, DocumentStatus status, String createdBy) {
