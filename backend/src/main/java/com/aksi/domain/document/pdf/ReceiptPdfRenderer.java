...
/**
 * Інтерфейс для рендерингу PDF-квитанцій.
 * Визначає методи для генерації різних секцій квитанції та повного документа.
 */
public interface ReceiptPdfRenderer {
     ...
     */
    void renderSignature(Document document, PdfWriter writer, ReceiptResponse receiptData, boolean includeSignature);
