...
public class DocumentValidationException extends RuntimeException {
    ...
    public static DocumentValidationException invalidStatus(DocumentStatus currentStatus, String operation) {
    ...
    public static DocumentValidationException duplicateDocumentNumber(String documentNumber) {
        return new DocumentValidationException(
            "Документ з номером '" + documentNumber + "' вже існує");
    }

    public static DocumentValidationException missingSignature(DocumentType documentType) {
        return new DocumentValidationException(
            "Документ типу " + documentType + " потребує підпису");
    }

    public static DocumentValidationException invalidFileFormat(String expectedFormat, String actualFormat) {
        return new DocumentValidationException(
