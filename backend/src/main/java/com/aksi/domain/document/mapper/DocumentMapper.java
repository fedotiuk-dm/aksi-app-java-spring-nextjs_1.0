...
/**
 * MapStruct Mapper для Document Domain Entity↔DTO конвертації
 * Спрощена версія за еталоном AuthMapper
 */
...
public interface DocumentMapper {
    ...
    /**
     * LocalDateTime (Entity) → OffsetDateTime (DTO)
     * Аналог з AuthMapper
     */
    ...
    default com.aksi.api.document.dto.DocumentType domainToApiDocumentType(DocumentType domainType) {
        return domainType != null ?
            com.aksi.api.document.dto.DocumentType.fromValue(domainType.name()) : null;
    }
    ...
    default DocumentType apiToDomainDocumentType(com.aksi.api.document.dto.DocumentType apiType) {
        return apiType != null ?
            DocumentType.valueOf(apiType.getValue()) : null;
    }
    ...
    default com.aksi.api.document.dto.DocumentStatus domainToApiDocumentStatus(DocumentStatus domainStatus) {
        return domainStatus != null ?
            com.aksi.api.document.dto.DocumentStatus.fromValue(domainStatus.name()) : null;
    }
    ...
    default DocumentStatus apiToDomainDocumentStatus(com.aksi.api.document.dto.DocumentStatus apiStatus) {
        return apiStatus != null ?
            DocumentStatus.valueOf(apiStatus.getValue()) : null;
    }
    ...
    default com.aksi.api.document.dto.SignatureType domainToApiSignatureType(SignatureType domainType) {
        return domainType != null ?
            com.aksi.api.document.dto.SignatureType.fromValue(domainType.name()) : null;
    }
    ...
    default SignatureType apiToDomainSignatureType(com.aksi.api.document.dto.SignatureType apiType) {
        return apiType != null ?
            SignatureType.valueOf(apiType.getValue()) : null;
    }
     ...
     */
    default DigitalSignatureEntity fromCreateDigitalSignatureRequest(CreateDigitalSignatureRequest request) {
    ...
    List<DigitalSignatureResponse> toDigitalSignatureResponseList(List<DigitalSignatureEntity> entities);
}
