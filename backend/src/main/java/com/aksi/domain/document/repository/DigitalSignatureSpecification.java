...
public class DigitalSignatureSpecification {
    ...
    // Type specifications
    public static Specification<DigitalSignatureEntity> hasSignatureType(SignatureType signatureType) {
        return (root, query, criteriaBuilder) ->
            signatureType == null ? null : criteriaBuilder.equal(root.get("signatureType"), signatureType);
    }

    public static Specification<DigitalSignatureEntity> hasSignatureTypeIn(List<SignatureType> signatureTypes) {
        return (root, query, criteriaBuilder) ->
            signatureTypes == null || signatureTypes.isEmpty() ? null : root.get("signatureType").in(signatureTypes);
    }
    ...
    public static Specification<DigitalSignatureEntity> isHandwrittenSignature() {
        return hasSignatureTypeIn(List.of(SignatureType.CLIENT_HANDOVER, SignatureType.CLIENT_PICKUP, SignatureType.OPERATOR));
    }
    ...
    public static Specification<DigitalSignatureEntity> signedByContains(String signedBy) {
        return (root, query, criteriaBuilder) ->
            signedBy == null ? null :
            criteriaBuilder.like(criteriaBuilder.lower(root.get("signedBy")),
    ...
    public static Specification<DigitalSignatureEntity> signedAfter(LocalDateTime dateTime) {
        return (root, query, criteriaBuilder) ->
            dateTime == null ? null : criteriaBuilder.greaterThanOrEqualTo(root.get("signedAt"), dateTime);
    }
    ...
    public static Specification<DigitalSignatureEntity> signedBetween(LocalDateTime from, LocalDateTime to) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<DigitalSignatureEntity> isValid() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.equal(root.get("isValid"), true);
    }

    public static Specification<DigitalSignatureEntity> isInvalid() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.equal(root.get("isValid"), false);
    }
    ...
    public static Specification<DigitalSignatureEntity> validUntilBefore(LocalDateTime dateTime) {
        return (root, query, criteriaBuilder) ->
            dateTime == null ? null : criteriaBuilder.lessThanOrEqualTo(root.get("validUntil"), dateTime);
    }
        ...
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.and(
                ...
                criteriaBuilder.greaterThan(
                    criteriaBuilder.length(root.get("signatureData")), 0
                )
            );
    }
    ...
    public static Specification<DigitalSignatureEntity> ipAddressStartsWith(String prefix) {
        return (root, query, criteriaBuilder) ->
            prefix == null ? null :
            criteriaBuilder.like(root.get("ipAddress"), prefix + "%");
    }
    ...
    public static Specification<DigitalSignatureEntity> readyForValidation() {
        return Specification.where(hasSignatureData())
            .and(isValid());
    }
    ...
    public static Specification<DigitalSignatureEntity> searchSignatures(SignatureType signatureType,
                                                                        String signedBy,
                                                                        Boolean isValid,
                                                                        LocalDateTime from,
                                                                        LocalDateTime to) {
    ...
    public static Specification<DigitalSignatureEntity> auditQuery(String operator,
                                                                  LocalDateTime from,
                                                                  LocalDateTime to) {
