...
/**
 * Domain enum для типів дефектів з business методами
 * API версія: com.aksi.api.item.dto.DefectType
 */
public enum DefectType {
    ...
    DefectType(String code, String displayName, boolean isRepairable,
               boolean affectsWarranty, double riskMultiplier) {
        this.code = code;
