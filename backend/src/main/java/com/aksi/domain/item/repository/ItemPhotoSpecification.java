...
/**
 * JPA Specifications для ItemPhotoEntity.
 * Замінює складні @Query методи на type-safe Criteria API.
 */
public class ItemPhotoSpecification {
    ...
    public static Specification<ItemPhotoEntity> isPrimary() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isTrue(root.get("isPrimary"));
    }
    ...
    public static Specification<ItemPhotoEntity> isNotPrimary() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isFalse(root.get("isPrimary"));
    }
    ...
    public static Specification<ItemPhotoEntity> hasThumbnail() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isNotNull(root.get("thumbnailPath"));
    }
    ...
    public static Specification<ItemPhotoEntity> hasNoThumbnail() {
        return (root, query, criteriaBuilder) ->
            criteriaBuilder.isNull(root.get("thumbnailPath"));
    }
     ...
     */
    public static Specification<ItemPhotoEntity> isHighResolution(Integer minWidth, Integer minHeight) {
        return (root, query, criteriaBuilder) -> {
