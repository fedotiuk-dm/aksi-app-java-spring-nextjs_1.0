...
/**
 * Repository для предметів прайс-листа з JPA Specification підтримкою.
 * Складні запити винесені в PriceListItemSpecification.
 */
@Repository
public interface PriceListItemRepository extends JpaRepository<PriceListItemEntity, Long>,
