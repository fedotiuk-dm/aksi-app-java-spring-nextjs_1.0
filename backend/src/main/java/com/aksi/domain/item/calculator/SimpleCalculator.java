...
/**
 * Простий калькулятор для 90% випадків використання
 * Обробляє PERCENTAGE та FIXED_AMOUNT модифікатори
...
public class SimpleCalculator {
    ...
    public CalculationResult calculate(Double basePrice, List<PriceModifierEntity> modifiers) {
        log.debug("Simple calculation for base price: {} with {} modifiers", basePrice, modifiers.size());
