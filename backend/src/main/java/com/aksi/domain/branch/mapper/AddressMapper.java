...
/**
 * Mapper для Address ↔ BranchEntity адресних полів
 * Відповідальність: конвертація між розширеними Entity полями та спрощеними API полями
 */
...
public interface AddressMapper {
    ...
    @Mapping(target = "buildingNumber", source = "street", qualifiedByName = "parseBuildingFromAddress")
    ...
    /**
     * Парсить вулицю з повної адреси (вилучає номери будинків)
     * Приклад: "вул. Хрещатик, 1" → "вул. Хрещатик"
     */
    ...
    /**
     * Парсить номер будинку з повної адреси
     * Приклад: "вул. Хрещатик, 1" → "1"
     */
    ...
    /**
     * Будує повну адресу для API з окремих полів Entity
     * Приклад: street="вул. Хрещатик", buildingNumber="1" → "вул. Хрещатик, 1"
     */
