...
/**
 * Mapper для BranchEntity ↔ DTO конвертації
 * Відповідальність: тільки основна Branch entity без embedded objects
 */
...
public interface BranchMapper {
    ...
    default com.aksi.api.branch.dto.BranchStatus domainBranchStatusToApi(
        ...
        return domainStatus != null ?
            com.aksi.api.branch.dto.BranchStatus.fromValue(domainStatus.name()) : null;
    }
    ...
    default com.aksi.domain.branch.enums.BranchStatus apiToDomainBranchStatus(
        ...
        return apiStatus != null ?
            com.aksi.domain.branch.enums.BranchStatus.valueOf(apiStatus.getValue()) : null;
    }
    ...
    default com.aksi.api.branch.dto.BranchOpenStatus domainOpenStatusToApi(
        ...
        return domainStatus != null ?
            com.aksi.api.branch.dto.BranchOpenStatus.fromValue(domainStatus.name()) : null;
    }
    ...
    default com.aksi.domain.branch.enums.BranchOpenStatus apiToDomainOpenStatus(
        ...
        return apiStatus != null ?
            com.aksi.domain.branch.enums.BranchOpenStatus.valueOf(apiStatus.getValue()) : null;
    }

    /**
     * Створити BranchStatisticsResponse на основі філії та періоду
     */
    default BranchStatisticsResponse toBranchStatisticsResponse(BranchEntity entity, LocalDate startDate, LocalDate endDate) {
    ...
    default List<BranchComparisonResponse> toBranchComparisonResponseList(
            List<BranchEntity> branches, LocalDate startDate, LocalDate endDate, String sortBy, String order) {
