...
public class WorkingDaySpecification {
     ...
     */
    public static Specification<WorkingDayEntity> workingHours(LocalTime openTime, LocalTime closeTime) {
        return Specification.where(opensAt(openTime))
            .and(closesAt(closeTime));
    }
     ...
     */
    public static Specification<WorkingDayEntity> lunchBreakAt(LocalTime lunchStart, LocalTime lunchEnd) {
        return (root, query, criteriaBuilder) -> {
    ...
    public static Specification<WorkingDayEntity> searchWorkingDays(
        ...
        Specification<WorkingDayEntity> spec = Specification.where(forSchedule(scheduleId))
            .and(isWorkingDay())
