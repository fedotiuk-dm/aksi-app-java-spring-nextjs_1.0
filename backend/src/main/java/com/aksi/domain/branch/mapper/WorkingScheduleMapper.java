...
/**
 * Mapper для WorkingScheduleEntity з правильними маппінгами
 * Відповідальність: тільки WorkingSchedule entity
 */
...
public interface WorkingScheduleMapper {
     ...
     */
    default BranchOpenStatusResponse toBranchOpenStatusResponse(UUID branchId, boolean isOpen, LocalDateTime checkDateTime) {
     ...
     */
    default NextWorkingDayResponse toNextWorkingDayResponse(UUID branchId, LocalDate nextWorkingDate) {
