...
/**
 * Mapper для WorkingDayEntity з правильними UUID конвертаціями
 * Відповідальність: тільки WorkingDay entity
 */
...
public interface WorkingDayMapper {
    ...
    default java.time.DayOfWeek map(com.aksi.api.branch.dto.DayOfWeek apiDayOfWeek) {
        return apiDayOfWeek != null ?
            java.time.DayOfWeek.valueOf(apiDayOfWeek.getValue()) : null;
    }
    ...
    default com.aksi.api.branch.dto.DayOfWeek map(java.time.DayOfWeek javaDayOfWeek) {
        return javaDayOfWeek != null ?
            com.aksi.api.branch.dto.DayOfWeek.fromValue(javaDayOfWeek.name()) : null;
    }
