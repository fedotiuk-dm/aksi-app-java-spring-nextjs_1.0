...
/**
 * Controller for order wizard operations.
...
public class OrderWizardController {
  ...
  /**
   * Get available items for a service in order wizard
   * This endpoint is critical for order creation flow
   */
  ...
  public ResponseEntity<List<ServiceItemInfo>> getAllServiceItems(
      @PathVariable UUID serviceId) {
