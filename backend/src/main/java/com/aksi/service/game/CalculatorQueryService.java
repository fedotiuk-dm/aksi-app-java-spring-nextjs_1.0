 ...
 * primarily for calculations, not data retrieval. Kept for CQRS architectural consistency.
 */
@Service
...
public class CalculatorQueryService {
  ...
  // Future: calculation history, pricing analytics, cached configurations
